...
const TrainerProfile = () => {
    ...
    return (
        <div className="min-h-screen bg-gmsdark-950 py-8">
                            ...
                            <div className="flex items-end gap-6">
                                ...
                                <div className="mb-2">
                                    ...
                                    <div className="mt-2 flex items-center gap-2">
                                        <span className="px-3 py-1 bg-primary-900/30 text-primary-400 text-xs font-bold rounded-full border border-primary-800/50">
                                            TRAINER
                                        </span>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-6">
                                    ...
                                    <section>
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                <p className="text-xs uppercase tracking-wider text-gray-500 font-bold mb-1">Specialization</p>
                                                <p className="text-white bg-dark-900/50 backdrop-blur px-4 py-2 rounded-lg border border-dark-700/50">
                                            ...
                                            <div className="grid grid-cols-2 gap-4">
                                                <div>
                                                    <p className="text-xs uppercase tracking-wider text-gray-500 font-bold mb-1">Gender</p>
                                                    <p className="text-white bg-dark-900/50 backdrop-blur px-4 py-2 rounded-lg border border-dark-700/50">
                                                        {profile?.gender || "Not provided"}
                                                    </p>
                                                </div>
                                                <div>
                                                    <p className="text-xs uppercase tracking-wider text-gray-500 font-bold mb-1">Age</p>
                                                    <p className="text-white bg-dark-900/50 backdrop-blur px-4 py-2 rounded-lg border border-dark-700/50">
                                    ...
                                    <section>
                                        ...
                                        <div className="bg-dark-900/50 backdrop-blur p-4 rounded-xl border border-dark-700/50 min-h-[100px]">
                                            <p className="text-gray-300 leading-relaxed italic">
                                                {profile?.bio || "No bio available. Add one to let people know more about your training philosophy!"}
                                            </p>
                                        </div>
                                    </section>
