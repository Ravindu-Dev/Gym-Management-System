                    ...
                    <div className="w-64 flex-shrink-0">
                        <div className="card sticky top-8">
                            ...
                            <nav className="space-y-4">
                                ...
                                <Link to="/trainer-profile" className="flex items-center space-x-3 px-4 py-3 text-gray-400 hover:bg-white/5 hover:text-white rounded-xl transition-all font-medium">
