        ...
        <div className="container mx-auto px-4 py-8">
            <div className="card">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                    ...
                    <Link to="/admin/scan" className="p-6 bg-dark-900 rounded-lg border border-dark-700 hover:border-primary-500 transition-colors group">
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-lg font-semibold text-white group-hover:text-primary-400 transition-colors">Scanner</h3>
                            <svg className="w-6 h-6 text-gray-500 group-hover:text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M5 8h2a1 1 0 001-1V5a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1zm12 0h2a1 1 0 001-1V5a1 1 0 00-1-1h-2a1 1 0 00-1 1v2a1 1 0 001 1zM5 20h2a1 1 0 001-1v-2a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1z"></path></svg>
                        </div>
                        <p className="text-gray-400 text-sm">Check-in members by scanning their QR code or entering ID.</p>
                    </Link>
                </div>
